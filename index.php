...
$works = [
    [
        'name' => 'Сотрудник банкетной службы',
        'date' => 'Февраль 2016 - Март 2020',
        'description' => 'Выполнение различных функций в банкетной службе ресторана',
    ],
    
    [
        'name' => 'Офис-менеджер',
        'date' => 'Март 2020 - Июль 2021',
        'description' => 'Выполнение различных функций в офисе',
    ],
    
    [
    	'name' => 'Специалист по закупкам',
        'date' => 'Июль 2021 - Апрель 2022',
        'description' => 'Выполнение различных функций на производстве',
    ],
];
